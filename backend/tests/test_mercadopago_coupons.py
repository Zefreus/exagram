...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://credito-hemograma.preview.emergentagent.com')
...
class TestMercadoPagoCheckout:
    ...
    def test_checkout_without_coupon(self):
        ...
        response = requests.post(f"{BASE_URL}/api/payments/checkout",
            json={
                "package_id": "single",
                "origin_url": "https://credito-hemograma.preview.emergentagent.com"
            },
            headers=headers
        )
